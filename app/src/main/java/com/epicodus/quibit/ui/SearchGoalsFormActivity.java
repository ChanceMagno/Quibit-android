...
public class SearchGoalsFormActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_goals_form);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth){
                ...
                if(user == null){
                    Intent intent = new Intent(SearchGoalsFormActivity.this, LoginActivity.class);
        ...
        switch (v.getId()) {
            case R.id.getStartedFloatingActionButton:
                ...
                if (goalSearch.equals("")) {
                    Toast toast = Toast.makeText(SearchGoalsFormActivity.this, "Please input an item to search for.", Toast.LENGTH_LONG);
                    toast.setGravity(Gravity.CENTER, 0, 100);
                    toast.show();
                } else {
                    mGoalSearch.setText("");
                    Intent intent = new Intent(SearchGoalsFormActivity.this, SearchGoalsActivity.class);
            ...
            case R.id.about:
                Intent intentAbout = new Intent(SearchGoalsFormActivity.this, MainActivity.class);
                startActivity(intentAbout);
                break;

            case R.id.logout:
//                logout();
                Intent intentNav = new Intent(SearchGoalsFormActivity.this, HomeActivity.class);
